...
class NavButton:
    ...
    def __init__(
        ...
        callback: typing.Callable[
            [Navigator, hikari.ReactionAddEvent],
    ...
    def press(
        self, nav: Navigator, event: hikari.ReactionAddEvent
    ) -> typing.Coroutine[typing.Any, typing.Any, None]:
        """
...
class EmbedNavigator(Navigator[hikari.Embed]):
    ...
    async def _edit_msg(
        self, message: hikari.Message, page: hikari.Embed
    ) -> hikari.Message:
