...
class EventListenerDescriptor:
    ...
    def __init__(
        ...
        callback: typing.Callable[
            [typing.Any, EventT_co], typing.Coroutine[typing.Any, typing.Any, None]
        ],
    ) -> None:
        ...
        for name, param in signature.parameters.items():
            if isinstance(param.annotation, str):
                param = param.replace(
                    annotation=resolved_typehints[name]
                    if name in resolved_typehints
        ...
        if event_type is None:
            ...
            if event_param.kind not in (
                ...
                raise TypeError(
                    "Expected two positional parameters on event listener (self, event)"
                )
            ...
            event_type = typing.cast(
                "typing.Type[hikari.Event]", event_param.annotation
            )
