...
def _bind_prototype(instance: typing.Any, command_template: _CommandT):
    ...
    class BoundCommand(type(command_template), _BoundCommandMarker):
        ...
        async def invoke(
            self, context: context_.Context, *args: str, **kwargs: str
        ) -> typing.Any:
            ...
            new_args = await self._convert_args(
                context, args, list(self.arg_details.args.values())[2 : len(args) + 2]
            )
            ...
            if kwargs:
                new_kwarg = (
                    await self._convert_args(
                        context,
                        kwargs.values(),
                        [self.arg_details.args[self.arg_details.kwarg_name]],
                    )
                )[0]
...
class SignatureInspector:
    ...
    def get_missing_args(self, args: typing.List[str]) -> typing.List[str]:
        required_command_args = [
            name for name, arg in self.args.items() if not arg.ignore and arg.required
        ]
...
class Command:
    ...
    def command_error(self):
        ...
        def decorate(
            func: typing.Callable[
                [events.CommandErrorEvent], typing.Coroutine[None, None, typing.Any]
            ]
        ) -> typing.Callable[
            [events.CommandErrorEvent], typing.Coroutine[None, None, typing.Any]
        ]:
    ...
    def before_invoke(self):
        ...
        def decorate(
            func: typing.Callable[
                [context.Context], typing.Coroutine[None, None, typing.Any]
            ]
        ) -> typing.Callable[
            [context.Context], typing.Coroutine[None, None, typing.Any]
        ]:
    ...
    async def _convert_args(
        ...
        for arg, details in zip(args, arg_details):
            ...
            if details.annotation is inspect.Parameter.empty or isinstance(
    ...
    async def invoke(
        ...
        new_args = await self._convert_args(
            context, args[: len(arg_details)], arg_details
        )
    ...
    def add_check(
        ...
        check_func: typing.Callable[
            [context.Context], typing.Coroutine[None, None, bool]
        ],
    ) -> None:
        """
...
class Group(Command):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._subcommands: typing.MutableMapping[str, Command] = (
    ...
    def add_check(
        self,
        check_func: typing.Callable[
            [context_.Context], typing.Coroutine[None, None, bool]
        ],
    ) -> None:
